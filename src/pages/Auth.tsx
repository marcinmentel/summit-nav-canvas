...
const Auth = () => {
  ...
  const handleSocialLogin = async (provider: 'google' | 'facebook') => {
    //onsole.log("clikcL0gin");
    window.location.href = "https://api.poweredbytrail.com/api/auth/login/google?returnUrl=https://www.poweredbytrail.com";
    
   //alert(`Inicjuję logowanie przez: ${provider}`);
          ...
          <CardContent>
            <Tabs defaultValue="login" className="w-full">
              ...
              <TabsContent value="signup">
                ...
                <div className="space-y-2">
                  <a
                    // 1. Użyj bezpośredniego atrybutu href zamiast onClick
                    href="https://api.poweredbytrail.com/api/auth/login/google?returnUrl=https://www.poweredbytrail.com"
                    
                    // 2. Dodaj wszystkie klasy CSS, które miał komponent Button
